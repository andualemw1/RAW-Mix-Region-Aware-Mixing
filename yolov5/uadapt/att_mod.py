...
https://github.com/elbuco1/CBAM/blob/master/src/models/models/cbam.py
...
cbam = CBAM(n_channels_in = 512, reduction_ratio = 2, kernel_size = 3) 

"""
x = torch.rand(4, 3, 20, 20)
output = cbam(x)
print("CBAM output", output.shape)
"""